...
<div class="container">
    <div class="card card-login mx-auto text-center bg-dark">
        <div class="card-header mx-auto bg-dark"><br>
...
<!--            <h1>--><?php //echo $message?><!--</h1>-->
        ...
        <div class="card-body">
            <form action="<?php echo base_url('User/user_check')?>" method="post">
            ...
            <div align="left">
                <label style="color: white">Not Registered !!! <a href="<?php echo base_url('index.php/User/User_register')?>"> <b style="color: white">Register Now</b></a></label>
            </div>
