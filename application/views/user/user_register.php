...
<!--            <h1>--><?php //echo $message?><!--</h1>-->
        ...
        <div class="card-body">
            <form action="<?php echo base_url('index.php/User/signup')?>" method="post" enctype="multipart/form-data">
              ...
              <div style="padding-right: 150px"><i style="color: white">Already Registered !! </i>
                    <a href="<?php echo base_url('User/index')?>" > <b style="color: white">Login Now</b></a>
                    </div><br>
